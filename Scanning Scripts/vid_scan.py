...
# **convert_to_mp4 function removed**
...
def perform_continuous_stack(cam, filename_h264, original_z):
    """Records video directly to raw H264 format."""
    
    encoder = H264Encoder(bitrate=BITRATE)
    
    print(f"    [REC] Starting recording: {os.path.basename(filename_h264)}")
    
    # Start Recording to the .h264 file
    ...
    # **Removed MP4 Conversion/Cleanup**
    print("    [REC] Saved raw H.264 file.")
